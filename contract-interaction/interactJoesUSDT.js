...
const contract = new ethers.Contract('0x7Eba7023307750b5C24f0d5B70caD1d158125E52', contractABI, wallet);

async function mint(index) {
  const tx = await contract.mint("0x2bEF0cb9F2F87bb605290f5a2112d57CfCe5c33A", 100000000000000);
  console.log("tx", tx);
